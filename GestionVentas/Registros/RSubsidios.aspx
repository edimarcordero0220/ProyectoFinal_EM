...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="panel-heading">Registro de Subsidios</div>
        ...
        <div class="panel-body">
            <div class="form-horizontal col-md-12" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <asp:TextBox ID="VendedorIdTextBox" runat="server" Class="form-control input-sm"></asp:TextBox>

                        <asp:RequiredFieldValidator ID="VendedorIdRFV" runat="server" MaxLength="50" ControlToValidate="VendedorIdTextBox" ErrorMessage="Campo VendedorId obligatorio" ForeColor="Red" Display="Dynamic" SetFocusOnError="True" ToolTip="Campo VendedorId obligatorio">Por favor llenar el campo VendedorId</asp:RequiredFieldValidator>
